...
<template>
  <va-card>
    ...
    <vudal name="simpleModalEditDepartment" class="widthModal">
      <div class="header">Screen Authorization Details<i class="close icon">&times;</i></div>
      <div class="content">
        <vue-form-generator
          :model="model"
...
export default {
  ...
  methods: {
    ...
    getAuthorizationLevel: async function() {
      const response = await servicesModule04.getAllSettingGeneralList('AUTHORIZATIONLEVEL');
